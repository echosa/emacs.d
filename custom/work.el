...
(custom-set-variables
 ...
 '(emacs-setup-keybindings (quote (("capitalize-word" . "C-c c") ("comment-region" . "C-c k") ("uncomment-region" . "C-c u") ("smex" . "M-x") ("scroll-up-line" . "M-n") ("scroll-down-line" . "M-p") ("other-window-backwards" . "C-x O") ("delete-other-windows-vertically" . "C-x 9") ("hs-goto-line" . "s-l"))))
 ...
 '(emacs-setup-post-sexp (quote ((when (fboundp (quote rainbow-delimiters-mode)) (add-hook (quote emacs-lisp-mode-hook) (quote rainbow-delimiters-mode))) (when (fboundp (quote paredit-mode)) (add-hook (quote emacs-lisp-mode-hook) (quote paredit-mode))) (setq completion-ignore-case t))))
 '(emacs-setup-pre-layout-sexp nil)
 '(emacs-setup-pre-sexp (quote (nil)))
 '(emacs-setup-require-list (quote (("uniquify") ("ido" (ido-mode) (icomplete-mode 99)) ("smex-autoloads") ("evil" (evil-mode) (define-key evil-ex-map "e " (quote ido-find-file)) (define-key evil-ex-map "b " (quote ido-switch-buffer))) ("evil-leader") ("my-funcs" (eval-after-load (quote ibuf-ext) (quote (my-ibuffer-load-hook)))) ("zf-mode"))))
