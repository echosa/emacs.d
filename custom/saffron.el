;; (load-file "~/Dropbox/emacs/my-cedet-setup.el")
;; (require 'my-cedet-setup)
...
;; (add-to-list 'load-path "~/Dropbox/github/emacs-kill-lines")
;; (require 'kill-lines)
...
(global-set-key "\C-c\M-%" 'reb-query-replace-this-regxp)
